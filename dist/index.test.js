...
ava_1.default('importSchema: import all from objects', function (t) {
    ...
    var expectedSDL = "type A {\n  first: String\n  second: Float\n  b: B\n}\n\ntype B {\n  hello: String!\n  c1: C1\n  c2: C2\n}\n\ntype C1 {\n  id: ID!\n}\n\ntype C2 {\n  id: ID!\n}\n";
    t.is(_1.importSchema(schemaA, { schemas: schemas }), expectedSDL);
});
...
ava_1.default('merged custom root fields imports', function (t) {
    var expectedSDL = "type Query {\n  helloA: String\n  posts(filter: PostFilter): [Post]\n  hello: String\n}\n\ntype Dummy {\n  field: String\n  field2: String\n}\n\ntype Post {\n  field1: String\n}\n\ninput PostFilter {\n  field3: Int\n}\n";
    var actualSDL = _1.importSchema('fixtures/merged-root-fields/a.graphql', { mergeableTypes: ['Dummy'] });
    t.is(actualSDL, expectedSDL);
});
ava_1.default('global schema modules', function (t) {
    var shared = "\n    type Shared {\n      first: String\n    }\n  ";
    var expectedSDL = "type A {\n  first: String\n  second: Shared\n}\n\ntype Shared {\n  first: String\n}\n";
    t.is(_1.importSchema('fixtures/global/a.graphql', { schemas: { shared: shared } }), expectedSDL);
});
